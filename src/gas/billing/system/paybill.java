...
public class paybill extends JFrame implements ActionListener {
    ...
    paybill(String meter) {
        ...
        JLabel heading = new JLabel("LPG Pipeline Bill");
        ...
        if (ae.getSource() == pay) {
            try {
                ...
                while (rs.next()) {
                    ...
                    System.out.println("Status: " + status); // Debugging output
                    if(status.equals("Not paid")) {
                        System.out.println("Navigating to paytm screen..."); // Debugging output
                        setVisible(false);
                        setpaid();
                        new paytm(meter);
                    ...
                    JOptionPane.showMessageDialog(null, "Bill status not found.");
                }
                }
            } catch (Exception e) {
                e.printStackTrace();
